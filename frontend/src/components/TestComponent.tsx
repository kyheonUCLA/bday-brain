...
const TestComponent: FC = () => {
  return (
		<nav className="bg-white border-gray-200 dark:bg-gray-900 w-auto h-auto">
  	<div className="w-full flex flex-row items-center justify-between mx-auto p-4 bg-orange-500">

    <div className="hidden md:block md:w-auto flex-row justify-center" id="navbar-default">
